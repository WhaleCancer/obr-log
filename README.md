...
- This extension subscribes to `OBR.room.onMetadataChange()`, `OBR.party.onChange`, and `OBR.player.onChange` so room and per-player log buffers both refresh the list.
