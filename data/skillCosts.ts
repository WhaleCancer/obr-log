 ...
 */
export function getSkillCost(skillType: SkillType, currentRank: number, newRank: number): number {
 ...
 */
export function getCumulativeSkillCost(skillType: SkillType, rank: number): number {
    if (rank <= 0) return 0;
